#' Plot Original Temporal Gene Expression Values
#'
#' \code{plotExpOriginal} plots original temporal gene expression values (query and reference)
#'
...
#' plotExpOriginal(query,timePoints_query,reference,timePoints_reference,title=gene)
#'
#' @export
#' @seealso \code{\link{plotDTW}} and \code{\link{plotExpAlignment}}
#' @author Peng Jiang \email{PJiang@morgridge.org}

plotExpOriginal <- function(query,
                            timePoints_query,
                            reference,
                            timePoints_reference,
                            title,
